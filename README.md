...
<div align="center">
 ...
 - [bc7enc_rdo](https://github.com/richgel999/bc7enc_rdo): the BC7 encoder every emulated colour texture is re-encoded with, vendored at `third_party/bc7enc` (MIT / public domain). It has the partitioned modes, so a 4x4 block holding two distinct colours is not forced onto one line; what Stud wrote by hand was single-subset and left visible squares on normal maps
