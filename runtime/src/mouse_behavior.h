...
//
//     mov  $0x4,%edi ; call <getter>      ; the object
//     mov  <d1>(%rbx),%rax                ; ...its input subsystem
//     cmpl $0x1,<d2>(%rax)                ; MouseBehavior == LockCenter
//
...
// loaded. Nothing here is a constant from a disassembly of one build; if
