...
// pthread_getspecific()-keyed helper). A search for other users of
// the real TLS key's own storage global found none, which is
// a known blind spot for indirect/PIC-relative
