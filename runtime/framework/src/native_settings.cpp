...
NativeSettingsResult run_native_settings_bootstrap(FakeJni::Jvm& jvm,
    ...
    // matched exactly here rather than an arbitrary order, since T0()'s
    // own real callers depend on this sequence (e.g. Q0()'s directory
    ...
    // (confirmed: R0() and P0() are called from unrelated places, never
