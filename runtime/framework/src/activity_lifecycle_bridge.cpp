...
ActivityLifecycleBridgeResult run_activity_lifecycle_bridge(FakeJni::Jvm& jvm,
    ...
    // immediately after -- see JNIActivityLifecycleCallbacks.java (the app's own code).
...
// Real ActivityNativeMain.onStart() pair (the app's own code, ActivityNativeMain.java:
// 1634-1639): applicationForegrounded() and setAppSuspended(false).
//
...
// nativePassSupportedRefreshRates(cm.a.k(display)) then
// nativePassCurrentDisplayRefreshRate(cm.a.a(display))), and with
