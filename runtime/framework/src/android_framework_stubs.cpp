...
// Real total system memory in MB, the quantity cm.a.c() reads from
...
std::string real_hardware_name() {
    static const std::string cached = [] {
        ...
        // product alone, which is what cm.a.b() does on a device.
...
// MANUFACTURER + " " + MODEL, matching cm.a.b(): the model is not
...
std::string real_device_name() {
    ...
    // n(), since they would corrupt the header.
    for (char& c : name) {
