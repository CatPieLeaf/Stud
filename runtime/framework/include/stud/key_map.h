...
// was pressed. Read straight out of the compiled entry point:
//
//   cmp  $0x7f,%ecx            ; ecx is the scan code
//   ja   ...                   ; above 127, nothing happens
//   mov  %ecx,%eax
//   lea  <table>(%rip),%rcx
//   mov  (%rcx,%rax,4),%r14d   ; table[scanCode] -> a USB HID usage code
//
