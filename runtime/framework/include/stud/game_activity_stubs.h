...
// (the app's own code against the app's own code, checked): onCreate() calls J2()
...
public:
    ...
    // Minimal C++ mirror of A2()/D2(): invoked when Roblox's own
...
// Confirmed (`com/roblox/client/JNIBaseUrlSetter.java`):
...
// Confirmed (`com/roblox/client/JNIAppRestarter.java`):
...
// Confirmed (`org/fmod/FMOD.java`, `org/fmod/AudioDevice.
...
// Confirmed (`org/fmod/AudioDevice.java`): FMOD's real
...
// Confirmed (`com/roblox/client/LocalStorageManager.java`):
...
// Confirmed (`com/roblox/client/game/ExperienceSession.java`):
...
// Confirmed (`com/roblox/client/startup/NativeHelper.java`):
