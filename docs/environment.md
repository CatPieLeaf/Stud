...
| `STUD_WL_NO_DEFAULT_DISPATCH` | off | Stops Stud dispatching the Vulkan driver's default Wayland queue, where it was discarding the driver's own `wl_buffer.release` events. |
